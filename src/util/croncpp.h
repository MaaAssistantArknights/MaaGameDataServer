...
#define  CONSTEXPTR
    ...
    struct cron_standard_traits {
        ...
        static const inline std::vector<std::string> MONTHS = {"NIL", "JAN", "FEB", "MAR", "APR", "MAY", "JUN", "JUL",
                                                               "AUG", "SEP", "OCT", "NOV", "DEC"};
#else
    ...
    struct cron_oracle_traits {
        ...
        static const inline std::vector<std::string> MONTHS = {"JAN", "FEB", "MAR", "APR", "MAY", "JUN", "JUL", "AUG",
                                                               "SEP", "OCT", "NOV", "DEC"};
#else
    ...
    namespace utils {
        ...
        inline std::tm to_tm(STRING_VIEW time) {
            ...
            std::tm result;
            str >> std::get_time(&result, "%Y-%m-%d %H:%Modal:%S");
        ...
        inline std::string to_string(std::tm const &tm) {
            ...
            str.imbue(std::locale(setlocale(LC_ALL, nullptr)));
            str << std::put_time(&tm, "%Y-%m-%d %H:%Modal:%S");
